...
print(paste(
  sum(data_GeneralPublic$`Have you published a systematic review - e.g. in a scientific journal or as a thesis?`=="Yes"),
  "out of",
  nrow(data_GeneralPublic),
  "researchers have answered Yes to the question 'Have you published a systematic review - e.g. in a scientific journal or as a thesis?'"
      ))
